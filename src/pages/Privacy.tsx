      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[#ccc] leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>Настоящая Политика конфиденциальности (далее — Политика) определяет порядок обработки и защиты персональных данных физических лиц (далее — Пользователей) при использовании сайта <strong>strongmontage.ru</strong> (далее — Сайт), принадлежащего ООО «Стронг-Монтаж» (далее — Оператор).</p>
          ...
          <section>
            ...
            <p>Сайт использует файлы cookie двух категорий: технические — необходимые для корректной работы Сайта, и аналитические (Яндекс.Метрика). При первом визите Пользователю показывается уведомление с выбором «Принять» или «Отклонить». Аналитические cookie и сервис Яндекс.Метрика подключаются <strong>только после согласия Пользователя</strong> (кнопка «Принять»); при отказе они не загружаются. Пользователь также может отключить cookie в настройках браузера, однако это может повлиять на работу отдельных функций Сайта.</p>
          </section>
          ...
          <p className="text-[#555] text-xs pt-4 border-t border-[#2a2a2a]">Дата последнего обновления: июль 2026 г.</p>
        </div>
      </div>
    </div>
  );
